package org.example.tregulov.annotation;

import java.lang.annotation.*;

public class Test2 {
    public static void main(String[] args) throws ClassNotFoundException {
        Class xiaomiClass = Class.forName("org.example.tregulov.annotation.Xiaomi");
        ...
        Class iphoneClass = Class.forName("org.example.tregulov.annotation.Iphone");
